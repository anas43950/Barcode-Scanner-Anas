...
import com.barcodescanner.databinding.FragmentDataMatrixBinding;
import com.barcodescanner.fragments.BaseFragment;

import java.util.regex.Pattern;


public class DataMatrixFragment extends BaseFragment {
    FragmentDataMatrixBinding binding;

    public DataMatrixFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDataMatrixBinding.inflate(inflater);
