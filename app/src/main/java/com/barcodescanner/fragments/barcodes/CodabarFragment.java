...
import com.barcodescanner.databinding.FragmentCodabarBinding;
import com.barcodescanner.fragments.BaseFragment;


public class CodabarFragment extends BaseFragment {
    FragmentCodabarBinding binding;
    public CodabarFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCodabarBinding.inflate(inflater);
